...
namespace ApiCore3AndTests.Infra.Configurations.Extensions.Validations
{
    ...
    {
        public static Error ToAggregatedError(this ActionContext context)
            => new Error(("400", "Has invalid values into request")) { Errors = context.BuildAggregatedErrors() };

        public static Error ToAggregatedError(this ActionContext context, (string, string) invalidPayloadError)
